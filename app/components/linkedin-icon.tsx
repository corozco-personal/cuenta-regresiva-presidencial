type Props = { size?: number; className?: string; "aria-hidden"?: boolean | "true" | "false" };

export default function LinkedInIcon({ size = 18, className, ...props }: Props) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor" role="img" {...props}>
