      ...
      <nav aria-label="Navegación principal">
        ...
        <details className="nav-more">
          ...
          <div className="nav-more-panel">
            <Link href="/">Inicio</Link><Link className="more-priority-2" href="/presidente">Sobre el presidente</Link><Link className="more-priority-3" href="/favorabilidad">Indicadores</Link><Link className="more-priority-4" href="/archivo">Archivo</Link><Link href="/temas">Expedientes</Link><Link href="/comparador">Comparador</Link><Link href="/nombramientos">Nombramientos</Link><Link href="/promesas">Promesas</Link><Link href="/resumen">Resumen semanal</Link><Link href="/alertas">Alertas</Link><Link href="/cobertura">Cobertura y estado</Link><Link href="/datos">Datos abiertos</Link><Link href="/compartir">Compartir</Link><Link href="/reportes">Reportes</Link><Link href="/fuentes">Fuentes</Link><Link href="/metodologia">Metodología</Link><Link href="/correcciones">Correcciones y réplica</Link><Link href="/acerca">Acerca de</Link><Link href="/autor">Quién soy</Link><Link href="/privacidad">Privacidad</Link>
          </div>
        </details>
      </nav>
